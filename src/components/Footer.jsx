...
const copy = {
  en: {
    description: 'Water treatment specialists with over 10 years serving homes in Florida.',
    schedule: 'Monday to Saturday: 8:00 AM - 6:00 PM',
    contact: 'Contact',
    where: 'Where are we?',
    writeWhatsApp: 'Message on WhatsApp',
    email: 'info@infinitywater.com',
    addressLine1: '3940 Metro Pkwy',
    addressLine2: 'Fort Myers, FL 33916, USA',
    rights: `© ${new Date().getFullYear()} Infinity Water. All rights reserved.`,
    design: 'Designed by'
  },
  es: {
    description: 'Especialistas en tratamiento de agua con más de 10 años sirviendo hogares en Florida.',
    ...
    email: 'info@infinitywater.com',
    addressLine1: '3940 Metro Pkwy',
    addressLine2: 'Fort Myers, FL 33916, EE. UU.',
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h3 className="text-white text-xl mb-6">{text.contact}</h3>
              <div className="space-y-4">
                ...
                <a
                  href={getWhatsAppUrl(language === 'en' ? 'Hi, I need help with water' : 'Hola, necesito ayuda con agua', PRIMARY_PHONE)}
                  target="_blank"
            ...
            <div>
              <h3 className="text-white text-xl mb-3">{text.where}</h3>
